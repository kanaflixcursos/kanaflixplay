    ...
    return (
      <div className="space-y-8">
        ...
        <motion.div
          ...
          className="relative overflow-hidden min-h-[340px] sm:min-h-[380px] flex items-center -mx-4 md:-mx-6 lg:-mx-8 -mt-4 md:-mt-6 lg:-mt-8 w-[100vw] max-w-none left-1/2 -translate-x-1/2 relative"
