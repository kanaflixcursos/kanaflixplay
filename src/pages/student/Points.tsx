...
const TIPS = [
  ...
  { icon: MessageCircle, label: 'Publicar um comentário', points: '+10 pts', description: 'Comente nas aulas para ganhar pontos. Máximo de 3 comentários com pontuação por dia (30 pts/dia).', color: 'text-teal-600 dark:text-teal-400', bg: 'bg-teal-100/60 dark:bg-teal-900/30' },
