  ...
  if (loading) {
    return (
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl md:text-3xl font-semibold tracking-tight">Minhas Compras</h1>
          <p className="text-muted-foreground text-sm mt-1">Histórico de pedidos e pagamentos</p>
        </div>
